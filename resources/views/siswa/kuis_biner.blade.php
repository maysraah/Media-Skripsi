...
<div class="container d-flex justify-content-center align-items-center center-container px-2">
    <div class="card shadow w-100" style="max-width: 600px;">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0">Instruksi Kuis Pencarian Biner</h5>
        </div>
        <div class="card-body">
        ...
        <div class="card-footer d-flex justify-content-end gap-2">
            @if (!($sudahMengerjakan && $lulus))
                ...
                <a href="{{ route('siswa.materi', ['bab' => 4, 'page' => 2]) }}" class="btn btn-danger">Batal</a>
                <a href="{{ route('kuis.kuis_biner') }}" class="btn btn-primary" id="modalKuisBtn">Kerjakan Kuis</a>
            @else
                <a href="{{ route('siswa.materi', ['bab' => 4, 'page' => 3]) }}" class="btn btn-secondary">Materi Selanjutnya</a>
            @endif
        </div>
    </div>
</div>
