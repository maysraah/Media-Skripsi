...
<head>
  ...
  <title>Kuis Pencarian Sentinel</title>
  <link rel="icon" type="image/png" href="{{ asset('storage/img/logo.png') }}">
  <meta name="csrf-token" content="{{ csrf_token() }}">
  <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.2/dist/css/bootstrap.min.css" rel="stylesheet">
  <link rel="stylesheet" href="{{ asset('css/kuis/kuis_sentinel.css') }}">
</head>
<body>
  <div class="container mt-4">
    <h1 class="text-center" style="color:#011B78">Kuis Pencarian Sentinel</h1>
    <div class="row mt-4">
  ...
  <script src="{{ asset('js/kuis/kuis_sentinel.js') }}"></script>
</body>
</html>
