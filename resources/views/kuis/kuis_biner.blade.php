...
<head>
  ...
  <link rel="stylesheet" href="{{ asset('css/kuis/kuis_biner.css') }}">
</head>
<body>
  <div class="container mt-4">
    <h1 class="text-center" style="color:#011B78">Kuis Pencarian Biner</h1>
    <div class="row mt-4">
  ...
  <script src="{{ asset('js/kuis/kuis_biner.js') }}"></script>
</body>
</html>
